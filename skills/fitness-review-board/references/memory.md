...
4. Submit new action instructions through the full board. After execution, compare the observed result with the expectation and record why to retain, revise or reverse it. A high proposal score is not an achieved fitness outcome.
