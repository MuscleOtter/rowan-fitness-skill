...
| First greeting's time estimate | States about 5–10 minutes for the basics and that digging up what has worked takes longer at the athlete's pace, with no number on it; lets the user skip what they would rather not share, promises no finish time for a reviewed plan, and offers to pause if the basics run long. |
