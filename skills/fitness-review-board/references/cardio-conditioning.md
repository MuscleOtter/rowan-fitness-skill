...
- [CDC relative intensity and talk test](https://www.cdc.gov/physical-activity-basics/measuring/index.html) and [ACSM intensity guide](https://www.acsm.org/docs/default-source/files-for-resource-library/exercise-intensity-infographic.pdf): useful effort anchors, with differing numerical scales; neither establishes an individual threshold.
