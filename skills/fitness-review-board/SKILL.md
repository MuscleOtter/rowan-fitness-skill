...
| “Show my progress”; compare results; tables or graphs | Ellis prepares verified data using [tables and graphs](references/fitness-visuals.md). Rowan presents one useful table or chart through actual host capabilities, with a table fallback. Descriptive display alone does not trigger a prescription board. |
